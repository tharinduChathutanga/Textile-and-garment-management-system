...
.product-card .right-column .colors-shirt {
  display: flex;
}
.product-card .right-column .colors-shirt span:not(:last-child) {
  width: 20px;
  height: 20px;
...
.product-card .right-column .colors-shirt .black {
  background: #000;
}
.product-card .right-column .colors-shirt .black:hover {
  border: solid 2px #000;
}
.product-card .right-column .colors-shirt .quantity {
  font-size: 1.2rem;
  font-weight: bold;
  align-self: center;
  margin-left: 100px;
}
.product-card .right-column .colors-shirt .quantity input {
  border: none;
