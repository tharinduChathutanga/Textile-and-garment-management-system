...
.product-card .right-column .colors-short {
  display: flex;
}
.product-card .right-column .colors-short span:not(:last-child) {
  width: 20px;
  height: 20px;
...
.product-card .right-column .colors-short .brown {
  background: rgb(190, 125, 39);
}
.product-card .right-column .colors-short .brown:hover {
  border: solid 2px rgb(190, 125, 39);
}
.product-card .right-column .colors-short .quantity {
  font-size: 1.2rem;
  font-weight: bold;
  align-self: center;
  margin-left: 100px;
}
.product-card .right-column .colors-short .quantity input {
  border: none;
